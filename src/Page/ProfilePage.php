...
class ProfilePage implements PageDriverInterface
{
    ...
    public function handle(
        ...
        // Profile title
        $profileTitle = $this->translator->trans("vadkuz-flarum2-seo.forum.profile_title", [
            'username' => $user->getAttribute('display_name'),
        ]);

        // Profile description
        $profileDescription = $this->translator->trans("vadkuz-flarum2-seo.forum.profile_description", [
            'username' => $user->getAttribute('display_name'),
