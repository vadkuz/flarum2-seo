![](https://img.shields.io/github/issues/vadkuz/flarum2-seo.svg) [![Total Downloads](https://poser.pugx.org/vadkuz/flarum2-seo/downloads)](https://packagist.org/packages/vadkuz/flarum2-seo) ![](https://img.shields.io/github/stars/vadkuz/flarum2-seo.svg) ![](https://img.shields.io/github/license/vadkuz/flarum2-seo.svg) ![](https://img.shields.io/packagist/v/vadkuz/flarum2-seo.svg)
...
```
composer require vadkuz/flarum2-seo
```

## ♻ Updating
Run the following command on your server to update the plugin
```
composer update vadkuz/flarum2-seo
```

## ⚒️ Extending & using in your own extension
You can use functionalities from this extension in your own extension. For more information, check [this knowledge base article](https://github.com/vadkuz/flarum2-seo).
...
- Default HTML meta tags:
  ...
  - keywords
  - language
- Adds ``robots.txt`` to your forum and includes a sitemap link. When `fof/sitemap` is disabled, this extension also provides a fallback `sitemap.xml`.
